...
var pais: any = jsonfile2.map(function (a) {
  return a.country;
});
...
export class GraficComponent {
  ...
  public barChartData: ChartData<'bar'> = {
    ...
    datasets: [
      ...
      { data: [alfabetitzacio[0], alfabetitzacio[1], alfabetitzacio[2], alfabetitzacio[3], alfabetitzacio[4], alfabetitzacio[5]], label: "Tasa d'alfabetització (%)", backgroundColor: ["#dcd9f8"] },
      { data: [pobresa[0], pobresa[1], pobresa[2], pobresa[3], pobresa[4], pobresa[5]], label: "Tasa de pobresa (%)", backgroundColor: ["#fdfd96"] },
  ...
  public barChartData2: ChartData<'bar'> = {
    ...
    datasets: [
      ...
      { data: [alfabetitzacio2[0], alfabetitzacio2[1], alfabetitzacio2[2], alfabetitzacio2[3], alfabetitzacio2[4]], label: "Tasa d'alfabetització (%)", backgroundColor: ["#dcd9f8"] },
      { data: [pobresa2[0], pobresa2[1], pobresa2[2], pobresa2[3], pobresa2[4]], label: "Tasa de pobresa (%)", backgroundColor: ["#fdfd96"] },
      ...
      { data: [atur[0], atur[1], atur[2], atur[3], atur[4]], label: "Tasa d'atur (%)", backgroundColor: ["#fdcae1"] },
    ]
  };
  ...
  public barChartData3: ChartData<'bar'> = {
    ...
    datasets: [
      ...
      { data: [alfabetitzacio2[5], alfabetitzacio2[6], alfabetitzacio2[7], alfabetitzacio2[8], alfabetitzacio2[9]], label: "Tasa d'alfabetització (%)", backgroundColor: ["#dcd9f8"] },
      { data: [pobresa2[5], pobresa2[6], pobresa2[7], pobresa2[8], pobresa2[9]], label: "Tasa de pobresa (%)", backgroundColor: ["#fdfd96"] },
      ...
      { data: [atur[5], atur[6], atur[7], atur[8], atur[9]], label: "Tasa d'atur (%)", backgroundColor: ["#fdcae1"] },
    ]
  };  
}